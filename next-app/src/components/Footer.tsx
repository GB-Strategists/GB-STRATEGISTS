    ...
    <footer className="bg-[#050B16] py-24 border-t border-white/5 relative z-30">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-20 items-start">
        ...
        <div className="space-y-8">
          ...
          <p className="text-[#8892b0] text-[15px] leading-relaxed max-w-xs">
        ...
        <div className="flex flex-col gap-6">
          <h4 className="font-mono text-[11px] text-[#E4A837] font-bold tracking-[0.3em] uppercase mb-4">SOCIAL & CASE STUDIES</h4>
          {[
            { label: 'Ganado Vital Ai', url: 'https://ganado-vital-ai.vercel.app/' },
