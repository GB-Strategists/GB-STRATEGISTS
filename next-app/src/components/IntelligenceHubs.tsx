 ...
 * Updated: Responsive Grid + High-end animations.
 */
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto px-6">
                ...
                >
                    <div className="bg-black/40 border border-[#24A8E1]/20 p-4 font-mono text-[10px] leading-tight mt-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-[#8892b0]">
                            <div>PRODUCCIÓN: <span className="text-white text-[9px]">Titanium Kit</span></div>
                            <div>PRECISIÓN: <span className="text-white text-[9px]">0.005mm</span></div>
                        </div>
                ...
                >
                    <div className="mt-6 h-32 relative bg-black/40 border border-[#24A8E1]/20 group overflow-hidden flex items-center justify-center">
                        ...
                        <div className="relative w-24 h-24 rounded-full border border-[#24A8E1]/30 flex items-center justify-center">
                            ...
                            <div className="w-1.5 h-1.5 bg-white rounded-full text-[8px] absolute top-4 right-4 animate-pulse">
                                <span className="ml-2 whitespace-nowrap text-[#24A8E1] font-mono">SIGNAL_ALPHA</span>
                            </div>
                        </div>
                ...
                >
                    <div className="flex flex-col gap-4 mt-6">
                        <ThreeCanvas type="aegis" height="150px" />
                    </div>
                </HubCard>
                ...
                <HubCard
                    ...
                    delay={0.3}
                >
                    <ThreeCanvas type="metatron" height="300px" style={{ borderColor: '#E4A837' }} />
                </HubCard>
